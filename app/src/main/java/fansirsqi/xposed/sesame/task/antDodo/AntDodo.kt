...
class AntDodo : ModelTask() {
    ...
    override fun getFields(): ModelFields {
        ...
        modelFields.addField(SelectModelField("collectToFriendList", "帮抽卡 | 好友列表", LinkedHashSet(), AlipayUser::getListAsMapperEntity).also { collectToFriendList = it })
        modelFields.addField(SelectModelField("sendFriendCard", "送卡片好友列表(当前图鉴所有卡片)", LinkedHashSet(), AlipayUser::getListAsMapperEntity).also { sendFriendCard = it })
