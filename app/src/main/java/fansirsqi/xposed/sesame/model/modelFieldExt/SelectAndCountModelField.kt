 ...
 * 选择并计数字段
 * 数据结构说明：
 * - Map<String, Int> 表示已选择的数据与已经设置的数量映射关系
...
class SelectAndCountModelField : ModelField<MutableMap<String, Int>>, SelectModelFieldFunc {
    ...
    constructor(code: String, name: String, value: MutableMap<String, Int>, expandValue: List<out MapperEntity>) 
        : super(code, name, value) {
        this.expandValue = expandValue
        this.selectListFunc = null
    }

    constructor(code: String, name: String, value: MutableMap<String, Int>, selectListFunc: SelectListFunc) 
        : super(code, name, value) {
        this.selectListFunc = selectListFunc
        this.expandValue = null
    }

    constructor(code: String, name: String, value: MutableMap<String, Int>, expandValue: List<out MapperEntity>, desc: String) 
        : super(code, name, value, desc) {
        this.expandValue = expandValue
        this.selectListFunc = null
    }

    constructor(code: String, name: String, value: MutableMap<String, Int>, selectListFunc: SelectListFunc, desc: String) 
        : super(code, name, value, desc) {
        this.selectListFunc = selectListFunc
        this.expandValue = null
    }
    ...
    override fun get(id: String?): Int? = value[id]
    ...
    override fun contains(id: String?): Boolean? = id?.let { value.containsKey(it) }
