...
object NetworkUtils {
    ...
    fun isNetworkAvailable(): Boolean {
        val context = fansirsqi.xposed.sesame.hook.ApplicationHookConstants.appContext ?: return false
    ...
    fun getNetworkType(): String {
        val context = fansirsqi.xposed.sesame.hook.ApplicationHookConstants.appContext ?: return "UNKNOWN"
